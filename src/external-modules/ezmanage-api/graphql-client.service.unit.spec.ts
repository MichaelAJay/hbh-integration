...
describe('GraphqlClientService', () => {
  ...
  describe('queryOrderName', () => {
    it('calls setAuthHeaderOnClient with the correct arguments', async () => {});
    it('calls client.request with the correct arguments', async () => {});
    it("throws OrderManagerError if order isn't found with matching id by client.request", async () => {});
    it('propagates any other error thrown by client.request', async () => {});
    it('throws OrderManagerError if return from client.request is not an object with "order" property', async () => {});
    it('throws OrderManagerError if order returned by client.request does not pass isGetOrdernameReturn validation', async () => {});
    it('returns a string (representing the order number) on success', async () => {});
    // it('propagates Bad Config error for missing auth token due to invalid ref', async () => {
    //   const mockArguments: { orderId: string; ref: ACCOUNT_REF } = {
    //     orderId: 'INCONSEQUENTIAL ORDER ID',
    //     ref: 'INVALID_TEST',
    ...
    //    */
    //   const mockOrderId = 'MOCK EXISTING ID';
    //   const mockResolvedValue = {
    //     order: {
    //       orderNumber: 'ORDER NUMBER UNDER TEST',
    //     },
    //   };
    //   jest
    //     .spyOn(service.client, 'request')
    //     .mockResolvedValue(mockResolvedValue);
    //   const orderNumber = await service.queryOrderName({
    //     orderId: mockOrderId,
    //     ref: 'H4H',
    //   });
    //   expect(orderNumber).toBe(mockResolvedValue.order.orderNumber);
    // });
  });
  describe('getCatererMenu', () => {
    it('calls service setAuthHeaderOnClient with the correct arguments', async () => {});
    it('calls client.request with the correct arguments', async () => {});
    it('throws OrderManagerError if client.request throws an error indicating that menu could not be found by catererId', async () => {});
    it('propagates any other error thrown by client.reqest', async () => {});
    it('throws OrderManagerError if return from client.request is not an object with "menu" property', async () => {});
    it('throws an OrderManagerError if client.request return does not pass isIGetH4HCatererMenu validator', async () => {});
    it('returns the response from client.request on success', async () => {});
    // it('propagates Bad Config error for missing auth token due to invalid ref', async () => {
    //   const mockArguments: { catererId: string; ref: ACCOUNT_REF } = {
    //     catererId: 'INCONSEQUENTIAL CATERER ID',
    //     ref: 'INVALID_TEST',
    //   };
    //   const expectedError = new InternalServerErrorException('Bad config');
    ...
    //   const mockArguments = { catererId: 'VALID CATERER ID', ref: 'H4H' };
    ...
    //   };
    //   jest.spyOn(service.client, 'request').mockResolvedValue(mockResponse);
    //   const ret = await service.getCatererMenu(mockArguments);
    //   expect(ret).toBe(mockResponse);
    // });
  });
});
